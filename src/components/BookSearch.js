...
const SearchBook = ({ addResultBooks }) => {
  ...
  const { searchBookListings, error: hookError, loading } = useSearchBookListings();
  ...
  const handleSubmit = async (e) => {
    ...
    const searchBookLists = await searchBookListings(searchTitle, author, location, condition);
        ...
        <Col className="d-flex flex-column align-items-center">
          <Form.Group controlId="title">
            <Form.Control
              type="text"
              placeholder="* Title"
              className="form-input-mandatory"
              value={searchTitle}
